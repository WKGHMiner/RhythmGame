...
const DifficultyRange = new ListRange("difficulty", ["A", "B", "C", "D", "E"], 2, item => {
...
const Control = new ControlButton(SpeedRange, DifficultyRange, OffsetRange, MusicVolumeRange, SoundVolumeRange, AllowVisioBox, AutoBox, ChartSelector);
